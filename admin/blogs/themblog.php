...
<head>
	...
	if ($title != "" && $content != "") {
		...
		$sql = "INSERT INTO `blogs` (`thumnail`, `title`, `content`,`description`) VALUES ('$link', '$title', '$content', '$description')";
...
<body class="flex">
	...
	<div class="flex-grow-1 flex">
		<form name="them_sp" class="w-[1200px] mx-auto my-auto p-6 border border-gray-400" method="post"
			action="themblog.php" enctype="multipart/form-data">
			<input type="hidden" name="form_add_blog" value="1">
			<div class="mb-3">

    ...
    <div class="flex-grow-1 p-6">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="button flex justify-end"><a style="color: white !important;"
                            href="/pig_shop/admin/categories/themcategories.php"><div class="btn btn-primary"> Thêm danh mục</div></a></div>
                <?php
                ...
                ?>
                <table class="table table-border table-hover mt-3" width="600" border="1">

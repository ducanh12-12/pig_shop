...
<body class="flex">
	...
	<div class="flex-grow-1 flex">
		<form name="them_sp" class="w-[1200px] mx-auto my-auto p-6 border border-gray-400" method="post"
			action="suablog.php?idhang=<?php echo $id ?>" enctype="multipart/form-data">
			<div class="mb-3">
				<label for="title" class="form-label">Tiêu đề bài viết</label>
				<input class="form-control" name="title" value="<?php echo $rows['title'] ?>" id="title" aria-describedby="">
				<!-- <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div> -->
			</div>
			<div class="mb-3">
				<label for="thumnail" class="form-label">Ảnh thumnail</label>
				<input type="file" class="form-control" name="image">
				<input type="hidden" class="form-control" value="<?php echo $rows['thumnail'] ?>"  name="image">
			</div>
            <div class="mb-3">

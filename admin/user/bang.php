						...
						<tr>
							...
							<tbody>
								<tr>
									...
									<td width="130">
										<div class="mb-3 mt-3 ">
											<input type="text" class="form-control form-control" id="name" placeholder="Nhập họ và tên" name="name">
										</div>
									</td> 	
								</tr>
								<tr>
									...
									<td width="130">
										<div class="mb-3 mt-3 ">
											<input type="date" class="form-control" id="date" placeholder="Ngày sinh" name="date">
										</div>
									</td> 
								</tr>
								<tr>
								...
								<tr>
									...
									<td width="130">
										<div class="mb-3 mt-3">
											<input type="number" class="form-control" id="phone" placeholder="Nhập SĐT" name="phone">
										</div>
									</td> 	
								</tr>
								<tr>
